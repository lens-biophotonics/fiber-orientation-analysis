...
def foa3d(cli_args):
    ...
    if not skip_frangi:
        tmp_hdf5_list, vec_volume, vec_colmap, frangi_volume, \
            ...
            = iterate_frangi_on_slices(volume, px_size, px_size_iso, smooth_sigma, save_dir, volume_name,
        ...
        save_frangi_volumes(vec_volume, vec_colmap, frangi_volume, fiber_mask, neuron_mask, save_dir, volume_name)
    ...
    if odf_scales_um:
        ...
        for odf_scale_um in odf_scales_um:
            odf_volume, bg_mrtrix_volume, tmp_hdf5_list \
                = iterate_odf_on_slices(vec_volume, iso_fiber_volume, px_size_iso, save_dir,
                                        max_slice_size=max_slice_size, tmp_files=tmp_hdf5_list,
        ...
        save_odf_volumes(odf_volume_list, bg_mrtrix_volume_list, save_dir, volume_name, odf_scales_um=odf_scales_um)
